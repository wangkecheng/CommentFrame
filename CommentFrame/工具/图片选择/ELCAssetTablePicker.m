...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            [self.navigationItem setTitle:self.singleSelection ? NSLocalizedString(@"选择照片", nil) : NSLocalizedString(@"选择多张照片", nil)];
...
{
	return SCREENWIDTH/4.0 - 1;//高度值是比里边的图片高度大一 里边四张图片 五个间隔，
}
