...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self = [self init]) {
        ...
        [self.iconView setBackgroundImage:IMG(imgName) forState:UIControlStateNormal];
        [self.iconView setBackgroundImage:IMG(imgName) forState:UIControlStateHighlighted];
...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self = [self init]) {
        ...
        [_iconView setBackgroundImage:IMG(imgName) forState:UIControlStateNormal];
        [_iconView setBackgroundImage:IMG(imgName) forState:UIControlStateHighlighted];
