...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        CALayer *lineOne = [[CALayer alloc] init];
        lineOne.frame = CGRectMake(0,self.titleHeight, SCREENHEIGHT, 1);
        lineOne.backgroundColor = UIColorFromRGB(240,240,240).CGColor;
        [_titleLabel.layer addSublayer:lineOne];
    }
    return _titleLabel;
}
...
- (UIButton *)cancelButton
{
    if (!_cancelButton) {
        ...
        CALayer *btnTopLine = [[CALayer alloc] init];
        btnTopLine.frame = CGRectMake(0, 0,ZY_ScreenWidth, 1);
        btnTopLine.backgroundColor = UIColorFromRGB(240,240,240).CGColor;
        [_cancelButton.layer addSublayer:btnTopLine];
    }
